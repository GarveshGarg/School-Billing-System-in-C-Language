...
int main()
{
    ...
    printf("\t\t\t\t|                                                      |\n");
    printf("\t\t\t\t========================================================\n");
    printf("\t\t\t\t|**WELCOME TO SCHOOL BILLING SYSTEM IN 'C' LANGUAGE''**|\n");
    printf("\t\t\t\t========================================================\n");
    printf("\t\t\t\t|               DEVELOPED BY GARVESH GARG                |\n");
    printf("\t\t\t\t========================================================\n");
    printf("\t\t\t\t|                                                      |\n");
   printf("\t\t\t\t*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*\n");
   printf("\n");
    ...
    system("color 6d");
    printf("\n\n\t\t\t\t** WELCOME TO SCHOOL BILLING SYSTEM IN 'C' LANGUAGE ''**\n\n");
    for(i=0; i<120; i++)
    {
        printf("\xdb");
    }
